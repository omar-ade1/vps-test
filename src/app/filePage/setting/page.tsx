  ...
  const getData = async () => {
    ...
    if (message.request.status == 200) {
      ...
      setInputsValues((prev) => ({
        ...
        // fullMark: message.data.message.Video.id,
        allowForStudent: message.data.message.File.allowForStudent,
      }));
    }
    ...
    <main className="min-h-[calc(100vh-64px)] py-[50px] relative">
      {isLoading ? (
        ...
        <div className="container">
          <h2 className="text-2xl font-bold rounded-xl shadow-xl p-5 border-2 w-[400px] max-w-full">اعدادات الملف</h2>
...
export default SettingFilePage;
